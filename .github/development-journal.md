...
- **Debug NMEA log** — an optional Settings toggle tees the raw NMEA from a Bluetooth run to a timestamped text file, shareable from Settings, for diagnosing the receiver's constellations, rate and HDOP.
